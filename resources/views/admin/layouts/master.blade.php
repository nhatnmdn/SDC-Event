	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="{{ route('admin.home') }}" class="{{ \Request::route()->getname() == 'admin.home' ? 'active' : '' }}"><i class="lnr lnr-home"></i> <span>Trang chủ</span></a></li>
						...
						<li><a href="{{ route('admin.get.list.personnel') }}"  class="{{ \Request::route()->getname() == 'admin.get.list.personnel' ? 'active' : '' }}"><i class="lnr lnr-dice"></i> <span>Nhân viên</span></a></li>
